     ...
     * Rust references are closer to C++ pointers (but with memory safety 
       ...
       * C++ references have this weird behaviour, where after initialization all 
         ...
         .. code-block:: output
            ...
            meal =Change Pizza to Sandwich through mea
   ...
   * When the code ``s = "Salut le monde!";``, the local variable ``s`` (stored on 
   ...
   2. Run the code: 
      ...
      .. code-block:: console 
         ...
         $ cargo run
            Compiling tut-005_strings_2 v0.1.0 (C:\Users\ricky\Workspace-loc\Repos\Pers\docs_allTest\source\topics\Prog\Lang\Wiki_Rust-lang\Courses\Wiki_RustTutorialDerek\_resources\Examples\tut-005_strings_2)
      ...
      .. note:: Notice the whenever we reassign ``s`` it points to a different 
         memory location.
