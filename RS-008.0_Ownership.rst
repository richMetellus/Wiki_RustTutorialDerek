...
Derrick did not give details or explanation, Let's uncomment the line and 
make some changes and add some description on what we've learn from the compiler message. 
